...
/*   Updated: 2026/07/18 09:01:42 by omawele          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	init_mlx(t_game *game)
{
	...
	if (!game->tex.display.img)
		return (err_mlx(1), 1);
	game->tex.display.addr = mlx_get_data_addr(game->tex.display.img, &game->tex.display.bits_per_pixel, &game->tex.display.line_length, &game->tex.display.endian);
